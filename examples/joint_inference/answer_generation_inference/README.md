...
1. little model inference worker: kubeedge/sedna-example-joint-inference-answer-generation-little:v0.3.0
2. big model inference worker: kubeedge/sedna-example-joint-inference-answer-generation-big:v0.3.0
  ...
  edgeWorker:
    ...
    template:
      spec:
        ...
        containers:
        - image: kubeedge/sedna-example-joint-inference-answer-generation-little:v0.3.0
  ...
  cloudWorker:
    ...
    template:
      spec:
        ...
        dnsPolicy: ClusterFirstWithHostNet
        containers:
          - image: kubeedge/sedna-example-joint-inference-answer-generation-big:v0.3.0
            name:  big-model
            imagePullPolicy: IfNotPresent
            env:
              - name: "BACKEND_TYPE"
